...
Contoh : *${prefix}tiktokstalk @mhmdfjralfarizi_*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}igstalk @mhmdfjralfarizi_*

*[@username]* Diisi dengan Username yang valid tanpa tanda “[” dan “]”
Contoh : *${prefix}smulestalk @mhmdfjralfarizi_*
...
Contoh : *${prefix}googlesearch siapa itu 𝙳𝚎𝚊 𝙱𝙾𝚃*
...
exports.info = info
const snk = () => {
    return `Syarat dan Ketentuan Bot *𝙳𝚎𝚊 𝙱𝙾𝚃*
